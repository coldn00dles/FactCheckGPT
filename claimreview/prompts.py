...
class Prompt:
    ...
    def __init__(self):
        ...
        Refer to your documents as your sources and don't say the word documents when referring to your database or entries. Do not lookup answers from the internet, answer only from your own sources. If not available simply state that in your sources there was no reliable answer for the same.
        ...
        Make sure to give a source in the form of URLs whenever needed, its on priority. Look for similiar sources in languages other than the inputted query as well, try to be more open to multi-lingual queries.
